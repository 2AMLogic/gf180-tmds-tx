# Record 20260817-001519-c991002

- **Record ID**: 20260817-001519-c991002
...
- **RC extraction**:
  - Rule deck: OpenROAD-flow-scripts' bundled gf180 platform typical-corner
    ...
    mismatch.
  - Result: 302 nets, 1366 rsegs, 1366 caps, 2137 coupling caps.
...
- **Reproducibility**: working tree clean at commit `c991002b0aa3b69ab7f7fb74bd82a8945895730c`.
- **Links**:
  ...
  - OpenSTA script: `flow/tmds_encoder/reports/20260817-001519-c991002.sta.tcl`
  - Full OpenSTA log: `flow/tmds_encoder/reports/20260817-001519-c991002.sta.log`
- **Timestamp / author**: 2026-08-17 00:15:19 UTC, `flow/sdf_tmds_encoder.py` (agent-run)
