# Record 20260817-105608-049c240

- **Record ID**: 20260817-105608-049c240
...
- **Result metrics** (from the captured OpenROAD log): {'core_area_um2': '33834.931', 'instances_area_um2': '12300.019', 'effective_utilization': '0.364', 'instance_count': '342', 'total_wire_length_um': '14686', 'via_count': '2172'}
...
- **Known limitations (disclosed, not silently worked around)**:
  ...
  4. **Two real, fixed defects, not currently-open ones**: an earlier
     ...
     design (see `20260817-105608-049c240.pnr.log`) independently reported zero violations
...
- **Links**:
  ...
  - OpenROAD script: `flow/tmds_encoder/reports/20260817-105608-049c240.pnr.tcl`
  - Full OpenROAD log: `flow/tmds_encoder/reports/20260817-105608-049c240.pnr.log`
  - GDS merge log: `flow/tmds_encoder/reports/20260817-105608-049c240.gds_merge.log`
- **Timestamp / author**: 2026-08-17 10:56:08 UTC, `flow/pnr_tmds_encoder.py` (agent-run)
