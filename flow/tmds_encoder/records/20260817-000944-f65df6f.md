# Record 20260817-000944-f65df6f

- **Record ID**: 20260817-000944-f65df6f
...
- **RC extraction**:
  - Rule deck: OpenROAD-flow-scripts' bundled gf180 platform typical-corner
    ...
    mismatch.
  - Result: 297 nets, 1355 rsegs, 1355 caps, 2122 coupling caps.
- **Worst-case unconstrained combinational delay observed**: 14.53 ns
...
- **Reproducibility**: working tree clean at commit `f65df6f285f8e2147e9cd4b12fe0f674c61a9da3`.
- **Links**:
  ...
  - OpenSTA script: `flow/tmds_encoder/reports/20260817-000944-f65df6f.sta.tcl`
  - Full OpenSTA log: `flow/tmds_encoder/reports/20260817-000944-f65df6f.sta.log`
- **Timestamp / author**: 2026-08-17 00:09:44 UTC, `flow/sdf_tmds_encoder.py` (agent-run)
