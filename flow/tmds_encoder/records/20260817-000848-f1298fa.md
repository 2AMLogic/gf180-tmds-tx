# Record 20260817-000848-f1298fa

- **Record ID**: 20260817-000848-f1298fa
...
- **Result metrics** (from the captured OpenROAD log): {'core_area_um2': '24498.432', 'instances_area_um2': '8681.702', 'effective_utilization': '0.354', 'instance_count': '272', 'total_wire_length_um': '12263', 'via_count': '1784'}
...
- **Known limitations (disclosed, not silently worked around)**:
  ...
  4. **Two real, fixed defects, not currently-open ones**: an earlier
     ...
     design (see `20260817-000848-f1298fa.pnr.log`) independently reported zero violations
     throughout, corroborating that the P&R itself was always sound and
     only the merge step was ever at fault.
- **Reproducibility**: working tree clean at commit `f1298fa6a337bcf5d08f54e6fc9324785fb97b83`.
- **Links**:
  ...
  - OpenROAD script: `flow/tmds_encoder/reports/20260817-000848-f1298fa.pnr.tcl`
  - Full OpenROAD log: `flow/tmds_encoder/reports/20260817-000848-f1298fa.pnr.log`
  - GDS merge log: `flow/tmds_encoder/reports/20260817-000848-f1298fa.gds_merge.log`
- **Timestamp / author**: 2026-08-17 00:08:48 UTC, `flow/pnr_tmds_encoder.py` (agent-run)
