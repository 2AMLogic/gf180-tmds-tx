# Record 20260817-001429-b33dfe3

- **Record ID**: 20260817-001429-b33dfe3
...
- **Result metrics** (from the captured OpenROAD log): {'core_area_um2': '24498.432', 'instances_area_um2': '8681.702', 'effective_utilization': '0.354', 'instance_count': '272', 'total_wire_length_um': '12414', 'via_count': '1799'}
...
- **Known limitations (disclosed, not silently worked around)**:
  ...
  4. **Two real, fixed defects, not currently-open ones**: an earlier
     ...
     design (see `20260817-001429-b33dfe3.pnr.log`) independently reported zero violations
     throughout, corroborating that the P&R itself was always sound and
     only the merge step was ever at fault.
- **Reproducibility**: working tree clean at commit `b33dfe31610e10ce7fea0b9fc5f973c166cebfd5`.
- **Links**:
  ...
  - OpenROAD script: `flow/tmds_encoder/reports/20260817-001429-b33dfe3.pnr.tcl`
  - Full OpenROAD log: `flow/tmds_encoder/reports/20260817-001429-b33dfe3.pnr.log`
  - GDS merge log: `flow/tmds_encoder/reports/20260817-001429-b33dfe3.gds_merge.log`
- **Timestamp / author**: 2026-08-17 00:14:29 UTC, `flow/pnr_tmds_encoder.py` (agent-run)
