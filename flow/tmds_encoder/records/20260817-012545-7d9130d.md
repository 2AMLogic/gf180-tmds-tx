# Record 20260817-012545-7d9130d

- **Record ID**: 20260817-012545-7d9130d
- **Claim**: A back-annotated SDF (real per-cell and per-net delays) and its
  ...
  record `20260817-012011-7d9130d`, git commit `7d9130d`) -- the pipelined (DR-0008)
...
- **P&R revision cited**: issue #110's evidence record `20260817-012011-7d9130d`
  (`flow/tmds_encoder/records/20260817-012011-7d9130d.md`), routed DEF
  `flow/tmds_encoder/pnr/tmds_encoder.def`, git commit `7d9130d`.
- **Tool versions**:
  - OpenROAD/OpenSTA: `26Q3-1080-gab6fd26351` (run via the `openroad/orfs:latest`
...
- **RC extraction**:
  - Rule deck: OpenROAD-flow-scripts' bundled gf180 platform typical-corner
    ...
    mismatch.
  - Result: 325 nets, 1438 rsegs, 1438 caps, 2110 coupling caps.
- **Worst-case unconstrained combinational delay observed**: 13.27 ns
...
- **Links**:
  ...
  - OpenSTA script: `flow/tmds_encoder/reports/20260817-012545-7d9130d.sta.tcl`
  - Full OpenSTA log: `flow/tmds_encoder/reports/20260817-012545-7d9130d.sta.log`
- **Timestamp / author**: 2026-08-17 01:25:45 UTC, `flow/sdf_tmds_encoder.py` (agent-run)
