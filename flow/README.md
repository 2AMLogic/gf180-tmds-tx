...
`gf180mcuD` per DR-0010 (`spec/decisions/0010-pdk-variant.md`, issue #9),
...
| gf180mcu PDK | `gf180mcuD` (DR-0010, issue #9), open_pdks `c6d73a35f524070e85faff4a6a9eef49553ebc2b` | `sim/pdk.json` (shared pin with the analog side) |
