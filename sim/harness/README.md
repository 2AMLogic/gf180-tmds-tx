...
| gf180mcu PDK (`gf180mcuD`) | device models | `pip install volare && volare enable --pdk gf180mcu <hash>` |
...
4. `sim/pdk.json` — committed default: `gf180mcuD` (see `sim/README.md`'s
   "PDK variant" section for why this variant, and the open question issue
   #9 owns).
